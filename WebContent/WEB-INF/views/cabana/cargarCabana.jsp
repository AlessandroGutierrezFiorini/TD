...
<body>
	...
	<form:form action="${pageContext.request.contextPath}/cabana/guardar"
		...
		<fieldset>
			<legend>Cargar Cabana</legend>

			<form:input path="id" type="hidden" value="" class="form-control" />
			<label class="control-label" for="mail">Numero:</label>
			<form:input path="numero" type="text" value="" class="form-control" />
			<label class="control-label" for="mail">Capacidad:</label>
			<form:input path="capacidad" type="text" value=""
				class="form-control" />
			<label class="control-label" for="mail">Habitaciones:</label>
			...
			<form:input path="internet" type="text" value="" class="form-control" />
			...
			<form:input path="mascotas" type="text" value="" class="form-control" />
